...
class Test_HW10(unittest.TestCase):
    ...
    def test_class_student(self):
        ...
        stevens: Repository = Repository(r"C:\\Users\\samee\\Desktop\\Second_Sem\\SSW_810\\HW11")
        list1 = list()
    ...
    def test_class_grade(self):
        db: sqlite3.Connection = sqlite3.connect("C:\\Users\\samee\\Desktop\\Second_Sem\\SSW_810\\HW11\\HW11_Tables")
        list1 = list()
